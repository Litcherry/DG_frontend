...
function KnowledgeContent() {
    ...
    async function load() {
        ...
        const [docs, faqData, cats, blind] = await Promise.all([
            request("/api/admin/knowledge/documents?page=1&page_size=100", {
                headers: authHeaders()
            }).catch(()=>({
                    items: []
                })),
            request("/api/admin/knowledge/faq?page=1&page_size=100", {
                headers: authHeaders()
            }).catch(()=>({
                    items: []
                })),
            request("/api/admin/knowledge/categories", {
                headers: authHeaders()
            }).catch(()=>[
                    "general"
                ]),
            request("/api/admin/knowledge/blind-spots?range=week", {
                headers: authHeaders()
            }).catch(()=>({
                    items: []
                }))
...
//# sourceMappingURL=%5Broot-of-the-server%5D__25e12155._.js.map