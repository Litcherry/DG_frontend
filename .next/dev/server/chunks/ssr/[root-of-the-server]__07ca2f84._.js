...
function ScenicContent() {
    ...
    async function saveSpot(event) {
        ...
        const saved = await request(spot.id ? `/api/admin/spots/${spot.id}` : "/api/admin/spots", {
        ...
        if (image && saved?.id) {
            ...
            await request(`/api/admin/spots/${saved.id}/image`, {
                method: "POST",
                headers: authHeaders(),
                body: form
            });
    ...
    async function deleteSpot(id) {
        ...
        await request(`/api/admin/spots/${id}`, {
            method: "DELETE",
            headers: authHeaders()
        });
        setMessage("景点已删除");
    ...
    async function backfillEnglish() {
        const data = await request("/api/admin/spots/backfill-name-en", {
            method: "POST",
            headers: authHeaders()
        });
    ...
    async function deleteRoute(id) {
        ...
        await request(`/api/admin/routes/${id}`, {
            method: "DELETE",
            headers: authHeaders()
        });
        setMessage("路线已删除");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07ca2f84._.js.map