...
function KnowledgeContent() {
    ...
    async function load() {
        ...
        const [docs, faqData, cats, blind] = await Promise.all([
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dg$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["request"])("/api/admin/knowledge/blind-spots?range=week", {
                headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dg$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authHeaders"])()
            }).catch(()=>({
                    items: []
                }))
